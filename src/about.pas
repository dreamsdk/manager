...
resourcestring
  ...
  ComponentCMake = 'CMake is the de-facto standard for building C++ code, with over 2 million downloads a month. It’s a powerful, comprehensive solution for managing the software build process. Get everything you need to successfully leverage CMake by visiting our resources section.';
...
const
  COMPONENTS_INFORMATION_COUNT = 30;
  COMPONENTS_INFORMATION: array[0..COMPONENTS_INFORMATION_COUNT - 1] of TComponentItem = (
    { 0} (Text: ComponentEnvironment;    Url: ''), // Environment
    { 1} (Text: ComponentMinGWMSYS;      Url: 'https://mingw.osdn.io/'), // MinGW/MSYS
    { 2} (Text: ComponentMinGWw64MSYS2;  Url: 'https://www.mingw-w64.org/'), // MinGW-w64/MSYS2
    { 3} (Text: ComponentToolchains;     Url: ''), // Toolchains
    { 4} (Text: ComponentBinutils;       Url: 'http://www.gnu.org/software/binutils/'), // Binutils
    { 5} (Text: ComponentGCC;            Url: 'http://gcc.gnu.org/'), // GCC
    { 6} (Text: ComponentNewlib;         Url: 'http://sourceware.org/newlib/'), // Newlib
    { 7} (Text: ComponentGDB;            Url: 'http://www.gnu.org/software/gdb/'), // GDB
    { 8} (Text: ComponentLibraries;      Url: ''), // Libraries
    { 9} (Text: ComponentKallisti;       Url: 'http://cadcdev.sourceforge.net/softprj/kos/'), // KallistiOS
    {10} (Text: ComponentKallistiPorts;  Url: 'http://cadcdev.sourceforge.net/softprj/kos/'), // KallistiOS Ports
    {11} (Text: ComponentDreamcastTool;  Url: 'http://cadcdev.sourceforge.net/softprj/kos/'), // Dreamcast Tool
    {12} (Text: ComponentDependencies;   Url: ''), // Dependencies
    {13} (Text: ComponentGit;            Url: 'http://git-scm.com/'), // Git
    {14} (Text: ComponentCMake;          Url: 'https://cmake.org/'), // CMake
    {15} (Text: ComponentPython;         Url: 'http://www.python.org/'),  // Python
    {16} (Text: ComponentMisc;           Url: ''), // Misc
    {17} (Text: ComponentFreePascal;     Url: 'http://www.freepascal.org/'), // Free Pascal
    {18} (Text: ComponentLazarus;        Url: 'http://www.lazarus-ide.org/'), // Lazarus
    {19} (Text: ComponentInnoSetup;      Url: 'http://www.jrsoftware.org/'), // Inno Setup
    {20} (Text: ComponentResources;      Url: ''), // ComponentResources
    {21} (Text: ComponentMainIcon;       Url: 'http://www.deviantart.com/martz90'), // Main Icon
    {22} (Text: ComponentSetupIcon;      Url: 'http://www.flaticon.com/authors/roundicons'), // Setup Icon
    {23} (Text: ComponentElevate;        Url: 'http://code.kliu.org/misc/elevate/'), // Misc/Elevate
    {24} (Text: ComponentDirHash;        Url: 'http://idrassi.github.io/DirHash/'), // Misc/DirHash
    {25} (Text: ComponentRuby;           Url: 'http://rubyinstaller.org/'), // Dependencies/Ruby
    {26} (Text: ComponentCodeBlocks;     Url: 'http://www.codeblocks.org/'), // Misc/Code::Blocks
    {27} (Text: ComponentMkIsoFs;        Url: 'http://cdrtools.sourceforge.net/private/cdrecord.html'), // Misc/Make ISO File System
    {28} (Text: ComponentCogsIcon;       Url: 'http://www.paomedia.com/'), // Cogs Icon
    {29} (Text: ComponentMeson;          Url: 'https://mesonbuild.com/') // Meson
  );
