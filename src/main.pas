...
type
  ...
  TfrmMain = class(TForm)
    ...
    tsDebug: TTabSheet;
    tsDependenciesPaths: TTabSheet;
    tsDependenciesVersions: TTabSheet;
...
{$ENDIF}
    ...
    // Dependencies paths
    edtPathGit.Text := Versions.GitPath;
    edtPathCMake.Text := Versions.CMakePath;
    edtPathPython.Text := Versions.PythonPath;
    edtPathRuby.Text := Versions.RubyPath;
    edtPathMeson.Text := Versions.MesonPath;
  end;
end;
...
{$ENDIF}
  ...
  case MsgBox(DialogWarningTitle, Msg, mtWarning, [mbYes, mbNo], mbNo) of
    mrYes:
      begin
        with PackageManager do
        begin
